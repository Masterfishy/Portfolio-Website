      ...
      <div id="about" className="container about__container">
        ...
        <div className="about__body">
          ...
          <div className="about__blurb">
            <p>
              Hello, hello! My name is Zach Long. I graduated Summa Cum Laude
              from Virginia Tech having studied computer science and
              mathematics. I have worked a wide range of software and research
              internships starting humbly with testing and moving my way through
              “the stack”. I participated in a number of bioinformatic and
              biostatistic research projects as a programmer, including a
              project that took me to Saudi Arabia.
            </p>
            <p>
              I have a passion for game design and game programming. At VT I
              lead meetings on game theory and game programming to peers and
              participated in 8 VT game jams we hosted.
            </p>
            <p>
              I am currently living in Hawaii taking some time to develop
              personal projects, like this website. I have also been enjoying
